        ...
        methods:{
            ...
            async saveAssociation(){
                try{
                    ...
                    await axios.post(`${import.meta.env.VITE_SERVER_URL}/associations`, formData, {
                        headers: {
                ...
                <div id="main">
                    <div class="section first">
                        ...
                        <div class="image">
                            ...
                            <div>
                                <img v-if="selectedImage && newImage" :src="selectedImage" alt="Selected image">
                                <button v-if="selectedImage && newImage" @click="removeImage">Remove image</button>
                            </div>
                        </div>
                    </div>
